...
final List<Map<String, dynamic>> _messages = []; // List of messages with sender info
...
children: [
if (!isAdmin) ...[
_buildProfilePicture('assets/tenant.png'), // Tenant profile picture
...
if (isAdmin) ...[
const SizedBox(width: 8),
_buildProfilePicture('assets/admin.png'), // Admin profile picture
],
],
),
);
